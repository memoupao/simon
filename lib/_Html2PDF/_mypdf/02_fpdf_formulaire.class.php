...
if (! defined('__CLASS_FPDF_FORMULAIRE__')) {
    ...
    class FPDF_Formulaire extends FPDF_BookMark
    {
        ...
        /*
         * Create a javascript PDF string. @access protected @author Johannes Güntert, Nicola Asuni
         */
        ...
        /*
         * Convert color to javascript color. @param string $color color name or #RRGGBB @access protected @author Denis Van Nuffelen, Nicola Asuni
         */
