...
<ul style="list-style-type: disc; width: 80%">
	<li>Point 1 :<br><?php echo $chaine; ?>
        </li>
	<li>Point 2 :<br><?php echo $chaine; ?>
			...
			<li>Point 2 :<br><?php echo $chaine; ?>
					...
					<li>Point 3 :<br><?php echo $chaine; ?>
                            <ul
							style="list-style-image: url(./res/puce.gif)">
							<li>Puce en image 1 :<br><?php echo $chaine; ?>
                                </li>
							<li>Puce en image 2 :<br><?php echo $chaine; ?>
                                </li>
							<li>Puce en image 3 :<br><?php echo $chaine; ?>
                                </li>
						</ul>
					</li>
				</ul>
