        ...
        ?>
							...
							<tr>
								...
								<td align="left" valign="top"><input name="t03_cant" type="text"
									id="t03_cant" style="text-align: right;" class="roundDec"
									value="<?php echo($row["t03_cant"]);?>" size="20"
									onkeyup="TotalizarPresup();" /></td>
								<?php */ ?>
								<td align="left" valign="top"><input name="t03_cant" type="text"
									id="t03_cant" style="text-align: right;" class="NOroundDec"
									value="<?php echo($row["t03_cant"]);?>" size="20"
									onkeyup="TotalizarPresup();" />
								</td>	
							...
							<tr>
								...
								<td align="left" valign="baseline"><input name="t03_cu"
									...
									class="roundDec"
									value="<?php echo(number_format($row["t03_cu"], 2));?>"
									size="20" onkeyup="TotalizarPresup();" /></td>
								<?php */ ?>
								
								<td align="left" valign="baseline"><input name="t03_cu"
									type="text" id="t03_cu" style="text-align: right"
									class="NOroundDec"
									value="<?php echo $row["t03_cu"];?>"
									size="20" onkeyup="TotalizarPresup();" /></td>
							...
							<tr>
								...
								<td align="left"><input name="t03_cost_parc" type="text"
									...
									value="<?php echo(number_format($row["t03_cost_parc"], 2));?>"
							...
							<tr>
								...
								<td align="left"><input name="t03_cost_tot" type="text"
									...
									value="<?php echo(number_format($row["t03_cost_tot"], 2));?>"
									size="20" readonly="readonly" /></td>
								<td valign="top">&nbsp;</td>
								<td colspan="2" valign="top">&nbsp;</td>
							</tr>
