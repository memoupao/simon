...
$urlEdicion = "ml_hip_OE_edit.php?idProy=$idProy&idVersion=$idVersion&idOE=$idComp";
...
<?php
$objFunc->SetSubTitle("Supuestos de Componentes");
?>
...
<body>
	...
	<form
		...
		<table width="742" height="42" border="0" cellpadding="0"
			...
			<tr>
				<td width="117" height="27"><span class="TextDescripcion"><strong>&nbsp;
							Componente</strong></span></td>
				<td width="625" align="left"><select name="t08_cod_comp"
	  ...
	  <?php
$rHip = $objML->ListadoSupuestosOE($idProy, $idVersion, $idComp);
$row_rsSupuestos = mysql_fetch_assoc($rInd); // Recuperamos el primer registro
					...
					<div class="TableGrid">
							...
							<table width="<?php echo($GridWidth -20);?>" border="1"
								...
								<thead>
									<tr>
										...
										<th>Descripcion de la Supuestos</th>
										<th width="20">&nbsp;</th>
									</tr>
								</thead>
								<tbody class="data">
                      <?php do { ?>
                        <tr class="RowData">
						  ...
						  <?php if($row_rsSupuestos['t08_cod_comp_sup']>0 && !$modificar) { ?>
							<a href="#"><img src="../../../img/b_edit.png" width="14"
													height="14" title="Editar Registro" border="0"
													onclick="Editar('<?php echo $row_rsSupuestos['t08_cod_comp_sup']; ?>');" /></a>
						  <?php } ?>
						  </span></td>
										<td width="40" nowrap="nowrap"><?php echo $row_rsSupuestos['t08_cod_comp_sup']; ?></td>
										<td align="left"><?php echo $row_rsSupuestos['t08_sup']; ?></td>
										<td width="20" align="left">
                          <?php /*if($row_rsSupuestos['t08_cod_comp_sup']>0 && !$modificar) { ?>
                            <a href="#"><img
												src="../../../img/b_drop.png" width="14" height="14"
												title="Eliminar Registro" border="0"
												onclick="Eliminar('<?php echo $row_rsSupuestos['t08_cod_comp_sup']; ?>', '<?php echo $row_rsSupuestos['t08_sup']; ?>');" /></a>													 
						  <?php }*/ ?>
                          </td>
									</tr>
