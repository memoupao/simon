...
<?php include("../../../includes/validauser.inc.php"); ?><?php
  ...
  <div>
			<div id="ssTabMP" class="TabbedPanels">
				<ul class="TabbedPanelsTabGroup">
					...
					<li class="TabbedPanelsTab" tabindex="1" onclick="LoadEquipamiento(false);">
	...
	{
		var BodyForm = "action=<?php echo(md5("lista_personal"));?>&idProy=<?php echo($idProy);?>&idVersion=<?php echo($idVersion);?>&modif=<?php echo $modif; ?>";
	...
	function LoadEquipamiento		(recargar)
	{
		...
		var BodyForm = "action=<?php echo(md5("lista_equipamiento"));?>&idProy=<?php echo($idProy);?>&idVersion=<?php echo($idVersion);?>&modif=<?php echo $modif; ?>";
	...
	function LoadGastoAdminis		(recargar)
	{
		...
		var BodyForm = "action=<?php echo(md5("gastos_administ"));?>&idProy=<?php echo($idProy);?>&idVersion=<?php echo($idVersion);?>&modif=<?php echo $modif; ?>";
	...
	function LoadLineaBase			(recargar)
	{
		...
		var BodyForm = "action=<?php echo(md5("linea_base"));?>&idProy=<?php echo($idProy);?>&idVersion=<?php echo($idVersion);?>&modif=<?php echo $modif; ?>";
