...
?>
        <div id="divTableLista">
			<table width="950" cellpadding="0" cellspacing="0" class="TableEditReg">
                ...
                $iRs = $objInf->listarIndicadoresComponenteSE($idProy, $idVersion, $idComp, $anio, $idEntregable);
                $RowIndex = 0;
                if ($iRs->num_rows > 0) {
            ...
            function Guardar_AvanceIndComp()
            {
                ...
                {
                	var sURL = "inf_monext_process.php?action=<?php echo(md5('ajax_ind_componente'));?>";
