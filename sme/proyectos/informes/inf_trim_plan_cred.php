...
<table width="780" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<th width="8%" rowspan="2" align="center" class="">
					<!--div style="text-align:center; color:navy; font-weight:bold; font-size:10px; cursor:pointer; width:60px;" title="Refrescar los Avances de Asistencia Técnica"  onclick="ReLoadPlanesCred();" > <img src="../../../img/gestion.jpg" width="24" height="24" /><br />
      Refrescar </div osktgui--> <input type="button" value="Refrescar"
				...
				<th width="10%" rowspan="2" align="center" valign="middle">
					<!--div style="text-align:center; color:navy; font-weight:bold; font-size:10px; cursor:pointer; width:50px;" title="Guardar participacion en los talleres de Capacitación"  onclick="Guardar_PlanCred();" > <img src="../../../img/aplicar.png" width="22" height="22" /><br />
    ...
    $iRsBenef = $objInf->InfTrim_Credito_Lista($idProy, $idAnio, $idTrim, $sub);
...
{
	var BodyForm = "action=<?php echo(md5("ListaPlanCred"));?>&idProy=<?php echo($idProy);?>&idAnio=<?php echo($idAnio);?>&idTrim=<?php echo($idTrim);?>&t25_ver_inf="+$('#t25_ver_inf').val()+"&cbosub=" + $('#cbosub.PlanCred').val() ;
