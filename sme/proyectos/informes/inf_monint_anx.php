...
?>
        <table width="750" border="0" cellspacing="1" cellpadding="0">
			<tr>
				...
				<td width="8%" rowspan="2" align="center" class="TableEditReg">
					<input type="button" value="Refrescar" onclick="LoadAnexosSI(true);" class="btn_save_custom" />
				</td>
    ...
    $iRs = $objInf->listarAnexosInfSI($idProy, $anio, $idEntregable);
    $RowIndex = 0;
    if ($iRs->num_rows > 0) {
     ...
     <tr>
       ...
       <td align="center" valign="middle">&nbsp;</td>
						<td height="30" align="center" valign="middle"><a
							...
							target="_blank"><?php echo($row['t45_nom_file']);?></a></td>
						<td align="left" valign="middle" nowrap="nowrap"><?php echo( $row['t45_desc_file']);?></td>
						<td align="center" valign="middle"><a
							href="javascript:EliminarAnexoFotografico('<?php echo($row['t45_cod_anx']);?>');"><img
    ...
    <tr>
						...
						<td align="center" nowrap="nowrap"><textarea name="t45_desc_file"
								rows="2" id="t45_desc_file" style="padding: 0px; width: 100%;"><?php echo($row['t45_desc_file']);?></textarea></td>
						<td width="52" align="center" valign="middle">&nbsp;</td>
					</tr>
				</tbody>
				<tfoot>
            ...
            function Guardar_Anexos()
            {
                ...
                f.action="inf_monint_process.php?action=<?php echo(md5('ajax_save_anexos'));?>" ;
            ...
            function EliminarAnexoFotografico(idanx)
            {
            	if(confirm("¿Estás seguro de eliminar el Anexo del Informe de Supervisión ?"))
            	{
            		...
            		$("#divLoadingAnexo").html("<p align='center'><img src='../../../img/indicator.gif' width='16' height='16' /><br>Cargando..<br></p>");
            		var sURL = "inf_monint_process.php?action=<?php echo(md5("ajax_del_anexos"))?>";
