...
?>
		...
		<div id="divTableLista" class="TableGrid">
				...
				<tbody class="data" bgcolor="#FFFFFF">
					<tr>
						<td align="left" valign="middle"><b>Avances</b> <br/>
						    <textarea name="avance" rows="7" id="avance" class="obs"><?php echo($row['t30_avance']);?></textarea>
					    </td>
					</tr>
					<tr>
						<td align="left" valign="middle">
						    <b>Logros</b><br/>
						    <textarea name="logros" rows="5" id="logros" class="obs"><?php echo($row['t30_logros']);?></textarea>
					    </td>
					</tr>
					<tr>
						<td align="left" valign="middle">
						    <b>Dificultades</b><br/>
						    <textarea name="dificul" rows="5" id="dificul" class="obs"><?php echo($row['t30_dificul']);?></textarea>
					    </td>
					</tr>
					<tr>
						<td align="left" valign="middle">
						    ...
						    <textarea name="recoProy" rows="5" id="recoProy" class="obs"><?php echo($row['t30_reco_proy']);?></textarea>
						</td>
					</tr>
					<tr>
						<td align="left" valign="middle">
						    ...
						    <textarea name="recoFE" rows="5" id="recoFE" class="obs"><?php echo($row['t30_reco_fe']);?></textarea>
						</td>
					</tr>
				</tbody>
				<tfoot>
            ...
            function Guardar_Conclusiones()
            {
                ...
                {
                	var sURL = "inf_monext_process.php?action=<?php echo(md5('ajax_conclusiones'));?>";
