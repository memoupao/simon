...
<script language="javascript" type="text/javascript"
     ...
     <tr style="border: solid 1px #CCC; background-color: #eeeeee;">
         ...
         <input name="t09_cod_act_ind[]" type="hidden"
					...
					<tr>
						...
						<td align="center" nowrap="nowrap"><input class="AM_Act"
						...
						<td align="center" nowrap="nowrap"><input MontoIndActMes='1'
							name="txtIndActMes[]" type="text" id="txtIndActMes[]"
							style="padding: 0px; width: 100%; height: 100%; text-align: center;"
					...
					<tr style="font-weight: 300; color: navy;">
						<td colspan="8" align="left" nowrap="nowrap">DESCRIPCION <br /> <textarea
    ...
    ?>
	 ...
	 function TotalAvanceIndicador(x)
		...
		$("input[MontoIndActMes='1']").numeric().pasteNumeric();		
		$('.AM_Act:input[readonly="readonly"]').css("background-color", "#eeeecc") ;  
