...
?>
        <div id="toolbar" style="height: 4px;">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="17%">
                        <button class="Button" onclick="LoadGastoAdminis(true); return false;" value="Recargar Listado">Refrescar Costos</button></td>
                    <td width="16%">
                        <button class="Button" onclick="GuardarGastosADM(); return false;" value="Guardar" style="white-space: nowrap;">Guardar Aportes</button></td>
                    <td width="5%">&nbsp;</td>
                    <td width="13%">&nbsp;</td>
                    <td width="43%" align="right">
                        <span style="color: #036; font-weight: bold; font-size: 12px;">Costos Administrativos</span></td>
        ...
        ?>
            <div class="TextDescripcion">Cuadro que muestra el Total de Costos Directos del proyecto</div>
                ...
                <div id="divTableFinan" class="TableGrid">
                    ...
                    del proyecto. <br\>El monto no podrá ser mayor al <?php echo ($datos['t02_porc_gast_func']);?>% de los costos
                    ...
                    <table width="600" border="0" cellpadding="0" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th width="17%" align="center" valign="middle">Monto Máximo (<?php echo ($datos['t02_porc_gast_func']);?>%)</th>
                                <th width="17%" align="center" valign="middle" nowrap="nowrap">Monto Aportado</th>
                            </tr>
                        </thead>
                        <tbody class="data">
                        <?php
                        $rsFte = $objMP->listarGastosAdmPOA($idProy, $idVersion);
                        ...
                        ?>
                            <tr class="RowData">
                                ...
                                <td align="right">
                                    ...
                                    size="17" maxlength="10" onkeyup="CalcularTotales();" montoADM='1' class="GastosAdministrativos roundDec" />
                                </td>
                            </tr>
                        <?php
                ...
                <table width="602" border="0" cellpadding="0" cellspacing="0" style="padding-left: 4px;">
                    <tr style="font-size: 11px;">
                        <th height="18" colspan="5" align="left" id="estiloga" style="padding-left: 4px;"></th>
                    </tr>
                </table>
