...
?>
      <div>
			<div id="toolbar" style="height: 4px;" class="BackColor">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="10%">
    					<?php if($isSE || $IsMF){?>
    				    <input type="checkbox" id="vb_se" name="vb_se" <?php echo($row['vb_se_fin']==1?'checked':'');?> <?php echo($IsMF?'disabled':'');?>/>V°B° SE
    			        <?php }?>
						...
						<td width="18%">
							<div style="float: 60px; left: 560px; position: absolute; top: 45px; width: 140px;">
								Año &nbsp;&nbsp;
                                ...
                                <input type="hidden" name="cboversion" id="cboversion" value="<?php echo($idVersion); ?>" />
							</div>
						</td>
			...
			<div align="left">
				<table width="438" border="0" align="left" cellpadding="0" cellspacing="0" class="TableEditReg" style="display: inline-block;">
					<tr>
						<td width="438">
                            ...
                            <fieldset>
								...
								<textarea name="txtobserv_cmf" cols="70" rows="3" id="txtobserv_cmf" class="Cabecera"><?php echo($row['t02_obs_cmf']);?></textarea>
                            </fieldset>
          <?php } ?>
   ...
   function GuardarPOA()
	...
	function POASuccessCallback	(req)
	{
	  ...
	  if(ret=="Exito")
	  {
		...
		alert(respuesta.replace(respuesta.substring(0,6),""));
		btnEditar_Clic('<?php echo($idProy);?>', '<?php echo($idAnio);?>');
	  }
	  else
	  {alert(respuesta);}
	}
