...
<div id="divTableLista" class="TableGrid">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tbody class="data" bgcolor="#FFFFFF">
      <?php
    $rowcab = $objPOA2->PlanCapacitacion_Seleccionar($idProy, $idVersion, $idComp, $idAct, $idSub);
    ...
    if ($iRs->num_rows > 0) {
      ...
      <tr class="RowSelected">
						<td width="58" align="center" valign="middle" nowrap="nowrap"
							...
							style="text-align: center; color: navy; font-weight: bold; font-size: 10px; cursor: pointer; width: 50px;">
								<!--img src="../../../img/aplicar.png" width="16" height="16" title="Guardar Responsable" onclick="GuardarTema();"/modificado-->
								<input value="Guardar" width="16" height="16"
								title="Guardar Responsable" onclick="GuardarTema();"
								class="btn_save" /> <img src="../../../img/closePopup.gif"
								width="16" height="16" title="Cancelar " onclick="LoadTemas();" />
						</span></td>
						<td align="center"><input type="hidden"
							name="t01_cod_rep" id="t01_cod_rep"
							value="<?php echo($t01_cod_rep);?>" /> <input name="txtcurso"
							type="text" id="txtcurso"
							value="<?php echo( $row['t12_tem_espe']); ?>" style="width: 99%;" maxlength="250" /></td>
      ...
      <tr>
						...
						<td align="left" valign="middle"><?php echo( $row['t12_tem_espe']);?></td>
    ...
    ?>
      ...
      <tr>
						<td width="58" align="center" valign="middle"><span
							style="text-align: center; color: navy; font-weight: bold; font-size: 10px; cursor: pointer; width: 50px;">
								<!--img src="../../../img/aplicar.png" width="16" height="16" title="Guardar Tema " onclick="GuardarTema();" /></spa modificado-->
								<input value="Guardar" width="16" height="16"
								title="Guardar Tema " onclick="GuardarTema();" class="btn_save" />
						</span></td>
						<td align="center" nowrap="nowrap"><input name="txtcurso"
							type="text" id="txtcurso" value="" style="width: 99%;" maxlength="250" /></td>
...
?>
				...
				<tfoot>
					<tr style="color: #FFF; font-weight: bold; height: 26px;">
						<td align="center" valign="middle">&nbsp;</td>
						<td align="center" valign="middle">&nbsp;Numero de Cursos: <?php echo( $sumtemas);?></td>
						<td align="center" valign="middle">&nbsp;&nbsp;&nbsp;
							<input
							name="txtnrohoras_total" type="text" id="txtnrohoras_total"
							value="<?php 
							// echo ($rowcab['t12_hor_cap'] ? $rowcab['t12_hor_cap'] : $sumhoras);
							echo $sumhoras;
							?>" size="10"
							style="width: 30%; text-align: center; font-size: 11px;" />
							<?php //echo( $sumhoras);?>
						</td>
						<td align="center" valign="middle">&nbsp;&nbsp;&nbsp;
							<input
							name="txtnrobenef_total" type="text" id="txtnrobenef_total"
							value="<?php 
							//echo $sumbenef;
							echo ($rowcab['t12_nro_ben'] ? $rowcab['t12_nro_ben'] : '0');
...
function GuardarTema()
{
 ...
 var horas_total = $('#txtnrohoras_total').val();
 var benef_total = $('#txtnrobenef_total').val();
 ...
 if(horas_total=='' || horas_total==null){alert("Ingrese numero total de horas"); $('#txtnrohoras_total').focus(); return false;}
 if(benef_total=='' || benef_total==null){alert("Ingrese numero total de beneficiarios"); $('#txtnrobenef_total').focus(); return false;}
 ...
 var arrParams = new Array();
	...
	arrParams[9] = "txtnrohoras_total=" + horas_total ;
	arrParams[10] = "txtnrobenef_total=" + benef_total ;
 ...
 var benef_total = $('#txtnrobenef_total').val();
	...
	if(confirm(" Estas seguro de eliminar el Registro seleccionado ["+idTema+"]?"))
	{
		var arrParams = new Array();
			...
			arrParams[6] = "txtnrohoras_total=" + horas_total ;
			arrParams[7] = "txtnrobenef_total=" + benef_total ;
...
function EditarTema(idTema)
  {
   ...
   $(document).ready(function(){
	   $("#txtnrohoras").numeric().pasteNumeric();
		...
		$("#txtnrohoras_total").numeric().pasteNumeric();
		$("#txtnrobenef_total").numeric().pasteNumeric();
	});
