...
<?php
$objFunc->SetTitle("Proyectos - Planificación de Otros Servicios");
$objFunc->SetSubTitle("Plan Específico - Otros Servicios");
?>
<!-- InstanceEndEditable -->
      ...
      <fieldset id="proyecto">
		  ...
		  function btnCancel_Clic()
		  {
			...
			function LoadPlanes()
			{
				...
				var sURL = "plan_otros_list.php?action=<?php echo(md5("edit_plan_capac"));?>";
