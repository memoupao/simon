...
<?php
$objFunc->SetTitle("Proyectos - Planes de Asistencia Tecnica");
$objFunc->SetSubTitle("Plan de Asistencia Tecnica");
?>
<!-- InstanceEndEditable -->
      ...
      <fieldset id="proyecto">
		  ...
		  function btnCancel_Clic()
		  {
			...
			function LoadPlanes()
			{
				...
				var sURL = "plan_at_list.php?action=<?php echo(md5("edit_plan_capac"));?>";
