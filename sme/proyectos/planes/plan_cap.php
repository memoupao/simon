...
<?php
$objFunc->SetTitle("Proyectos - Planes de Capacitación");
$objFunc->SetSubTitle("Plan de Capacitación");
?>
<!-- InstanceEndEditable -->
      ...
      <fieldset id="proyecto">
		  ...
		  function btnCancel_Clic()
		  {
			...
			function LoadPlanes()
			{
				...
				var sURL = "plan_cap_list.php?action=<?php echo(md5("edit_plan_capac"));?>";
