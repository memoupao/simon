...
<div id="divTableLista">
			<table width="771" border="1" cellpadding="0" cellspacing="0">
				<tr style="border: solid 1px #CCC; background-color: #eeeeee;">
					...
					<th height="28" colspan="3" align="center" valign="middle">Total Periodo <?php echo(" (".$row['t51_per_ini']." - ".$row['t51_per_fin'].")"); ?></th>
    ...
    <tfoot>
			...
			<input type="hidden" name="t02_cod_proy"
				...
				class='fisico' /> <input type="hidden" name="t51_num" id="t51_num"
				value="<?php echo($idInforme);?>" class='fisico' />
			<script language="JavaScript" type="text/javascript">
