   ...
   <div id="toolbar" style="height: 4px;" class="BackColor">
        ...
        ?>
			...
			<div id="ssTabInforme" class="TabbedPanels">
					...
					<div class="TabbedPanelsContent">
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								<td width="8%">&nbsp;</td>
								<td colspan="2">&nbsp;</td>
								<td width="36%" rowspan="4" align="center" valign="middle"><div
										style="text-align: center; color: navy; font-weight: bold; font-size: 10px; cursor: pointer; width: 120px;"
										title="Guardar Comentarios" onclick="GuardarComentarios();">
										<img src="../../../img/aplicar.png" width="24" height="24"
											alt="Guardar Avances" /><br /> Guardar Comentarios
									</div></td>
							</tr>
							<tr>
                ...
                ?>
                <option value="mp" style="color: navy;">90.- Manejo del
											Proyecto</option>
								</select></td>
								<td align="left">&nbsp;<img src="../../../img/btnRecuperar.gif"
									width="17" height="17" style="cursor: pointer;"
									onclick="LoadAvancePresupuestal();"
									title="Refrescar Presupuesto" /></td>
							</tr>
							<tr>
								<td colspan="3"></td>
							</tr>
                ...
                $objFunc->llenarComboI($rs, 't08_cod_comp', 'componente', '');
                ?>
                  <option value="mp" style="color: navy;">90.- Manejo
												del Proyecto</option>
									</select> <img src="../../../img/btnRecuperar.gif" width="17"
										height="17" style="cursor: pointer;"
										onclick="LoadAvanceFisico();" title="Refrescar Avance Fisico" /></td>
									<td width="2%" align="center">&nbsp;</td>
									<td width="36%" align="center" valign="middle"><div
											style="text-align: center; color: navy; font-weight: bold; font-size: 10px; cursor: pointer; width: 112px;"
											title="Guardar Comentarios" onclick="GuardarComentarios2();">
											<img src="../../../img/aplicar.png" width="24" height="24"
												alt="Guardar Gastos" /><br /> Guardar Comentarios
										</div></td>
								</tr>
							</table>
...
?>
	...
	function LoadExcedentes(arg)
	{
		...
		var BodyForm = "action=<?php echo(md5("lista_excedentes"));?>&idProy=<?php echo($idProy);?>&idNum=<?php echo($idInforme);?>";
	...
	function LoadAnexos(recargar)
	{
		...
		var anio = $('#cboanio').val();
		var mes = $('#cbomes').val();
		var BodyForm = "action=<?php echo(md5("lista_anexos"));?>&idProy=<?php echo($idProy);?>&idNum=<?php echo($idInforme);?>";
