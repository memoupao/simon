...
<title>Anexos Informe Monitor Financiero</title>
<!-- InstanceEndEditable -->
...
<table width="750" border="0" cellspacing="1" cellpadding="0">
			<tr>
				<td width="82%" align="left" class="TableEditReg"><span
					style="font-weight: bold;">Anexos del informe de Monitoreo
						Financiero</span></td>
    ...
    $iRs = $objInf->Inf_MF_ListaAnexos($idProy, $idNum);
    $RowIndex = 0;
    if ($iRs->num_rows > 0) {
     ...
     <tr>
       ...
       <td align="center" valign="middle">&nbsp;</a></td>
						...
						<td align="center" valign="middle"><a
							href="javascript:EliminarAnexoFotografico('<?php echo($row['t51_cod_anx']);?>');"><img
    ...
    <tr>
						...
						<td align="center" nowrap="nowrap"><textarea name="t51_desc_file"
								rows="2" id="t51_desc_file" style="padding: 0px; width: 100%;"><?php echo($row['t51_desc_file']);?></textarea></td>
						<td width="52" align="center" valign="middle">&nbsp;</td>
					</tr>
				</tbody>
				<tfoot>
...
function Guardar_Anexos()
{
 ...
 var desc = $('#t51_desc_file').val();

 if(foto=='' || foto==null){alert("No ha seleccionado el Anexo a cargar");return false;}
 if(desc=='' || desc==null){alert("Ingrese Descripcion del archivo Avexado a Cargar");return false;}
...
function EliminarAnexoFotografico(idanx)
{
	...
	{
		var BodyForm = "t02_cod_proy="+$('#txtCodProy').val()+"&t51_id=<?php echo($idNum); ?>&t51_cod_anx="+idanx;
		$("#divLoadingAnexo").html("<p align='center'><img src='../../../img/indicator.gif' width='16' height='16' /><br>Cargando..<br></p>");
		...
		var req = Spry.Utils.loadURL("POST", sURL, true, AnexosSuccessCallback, { postData: BodyForm, headers: { "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8" }, errorCallback: MyErrorCall});
			...
			<input name="t51_id" type="hidden" id="t51_id"
