...
$objFunc->SetTitle("Autorización para Giro de Cheques - Gestores Fondoempleo");
$objFunc->SetSubTitle("Autorización para Giro de Cheques");
...
<?php */ ?>  
    ...
    <?php include("../../../includes/subtitle.php");?>
		...
		<div id="mainContent">
            ...
            $objFunc->llenarComboI($rs, 'codigo', 'abreviatura', "09");
            ?>
            </select></td>
...
{
	var url = "aprob_desemb_lista.php?mode=<?php echo(md5("ajax_list"));?>&cboconcurso="+$("#cboconcurso").val() + "&cboinstitucion=" + $("#cboinstitucion").val() ;
