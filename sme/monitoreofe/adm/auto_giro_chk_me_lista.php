...
<title>Autorización para Giro de Cheques para Supervisores Externos</title>
<!-- InstanceEndEditable -->
			...
			<table border="0" cellpadding="0" cellspacing="0">
				<tbody class="data">
					...
					<tr>
						...
						<td width="167" align="center" valign="middle" bgcolor="#E9E9E9"><strong>Supervisor Externo</strong></td>
...
function viewDesembolso(idproy, idVisita, idApro)
  {
	...
	loadPopup("<?php echo("Desembolsos del Supervisora Externo");?>",url);
	return;
  }
