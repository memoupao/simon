...
$objFunc->SetTitle("Ejecución de Desembolsos - Administracion");
...
<link href="../../../css/aprob_desemb.css" rel="stylesheet" media="all" />
...
<body class="oneColElsCtrHdr">
    ...
    <?php include("../../../includes/subtitle.php");?>
		...
		<div id="mainContent">
			<form id="FormData" method="post"
				...
				<fieldset style="width: 600px; padding: 1px; font-size: 10px;">
									...
									<tr>
										<td width="527">
											<table width="100%" border="0" cellpadding="0"
												...
												<tr>
													<td width="55" height="44" valign="middle" nowrap="nowrap"><strong>Concurso</strong></td>
            ...
            ?>
													...
													<td width="114" valign="middle" nowrap="nowrap"><strong>Institución
															Ejecutora</strong></td>
													<td width="230" valign="middle"><select
            ...
            ?>
										...
										<td width="59" align="center" valign="middle" id="toolbar"><span>
												<button name="btnRefrescar" value="Refrescar" class="Button"
													id="btnBuscar" onclick="LoadDataGrid(); return false;">Buscar</button>

												<button id="exportar" class="Button"
													onclick="ExportarDesemb(); return false;" value="Exportar">Exportar</button></td>
 ...
 function loadPopup(title, url)
  ...
  function ExportarDesemb()
	{
	
	var fecha = new Date();

		var arrayControls = new Array();
			arrayControls[0] = "cboConcurso=" + $("#cboconcurso").val();
			arrayControls[1] = "cboEjecutor=" + $("#cboinstitucion").val();
			arrayControls[2] = "cboMesIni=" + (fecha.getMonth()+1);
			arrayControls[3] = "txtanioini=" + fecha.getFullYear();
			arrayControls[4] = "cboMesFin=" + (fecha.getMonth()+1);	
			arrayControls[5] = "txtaniofin=" + fecha.getFullYear();
...
{
	var url = "ejec_desemb_lista.php?mode=<?php echo(md5("ajax_list"));?>&cboconcurso="+$("#cboconcurso").val() + "&cboinstitucion=" + $("#cboinstitucion").val() ;
