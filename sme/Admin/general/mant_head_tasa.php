 ...
 * CticServices
 *
 * Código reutilizable incuido en la cabecera para el mantenimiento de tasas.
 *
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="10%" nowrap="nowrap">
									<button class="Button" name="btnNuevo" id="btnNuevo2"
										onclick="LoadDataGrid(); return false;" value="Nuevo">Refrescar</button>
									<!--  <button class="Button" name="btnNuevo" id="btnNuevo" onclick="btnNuevo_Clic(); return false;" value="Nuevo">Nuevo</button> -->
								</td>
