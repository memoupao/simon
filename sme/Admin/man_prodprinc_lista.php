...
$objFunc->SetTitle("Mantenimiento de Productos principales - Modulo Administración");
$objFunc->SetSubTitle("Mantenimiento de Productos principales");
...
<script type="text/javascript">
	...
	function LoadDataGrid()
	{
		...
		var xmlurl = "man.xml.php?action=<?php echo(md5("lista_subtablas_aux3"));?>&idTabla=" + idtabla + "&idTablaAux="+idtablaaux ;
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td height="22" align="center" nowrap="nowrap"
							style="font-size: 12px;">&nbsp;<strong>Sector</strong>
							&nbsp;
						</td>
						<td><select name="cbotabla" id="cbotabla" style="width: 250px" onchange="CargarListaTablasaux();">
						  <option></option>
      <?php
    ...
    ?>
					...
					<tr>
						<td height="32" align="center" nowrap="nowrap"
							style="font-size: 12px;">&nbsp;<strong>Subsector </strong></td>
 ...
 function btnNuevo_Clic()
  {
	...
	$("#divContent").css('display', 'none');
	var url = "man_prodprinc_edit.php?mode=<?php echo(md5("ajax_new"));?>&id=&idtabla="+$('#cbotabla').val() + "&idtablaaux=" +$('#cbosubtabla').val() ;
 ...
 function btnEditar_Clic(id)
  {
	...
	var url = "man_prodprinc_edit.php?mode=<?php echo(md5("ajax_edit"));?>&id="+id+"&idtabla="+$('#cbotabla').val() + "&idtablaaux=" + $('#cbosubtabla').val() ;
	loadUrlSpry("divContentEdit",url);
	$("#divContent").fadeOut("slow");
	$("#divContent").css('display', 'none');
 ...
 function CancelEdit()
 {
  ...
  {	  alert("ERROR: " + req);   }
   ...
   function CargarListaTablasaux()
	{
	  var pURL = "man_prodprinc_process.php?action=<?php echo(md5("lista_tablas_aux3"));?>&idTabla="+$('#cbotabla').val();
