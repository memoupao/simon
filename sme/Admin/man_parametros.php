...
$objFunc->SetTitle("Mantenimiento de Parametros");
$objFunc->SetSubTitle("Mantenimiento de Parametros");
...
<script type="text/javascript">
	...
	{
		var xmlurl = "man.xml.php?action=<?php echo(md5("lista_parametros"));?>";
		...
		{
			dsLista = new Spry.Data.XMLDataSet(xmlurl, "parametro/rowdata", {useCache: false});			
						...
						<table class="grid-table grid-width">
							<thead>
								<tr>
									...
									<th width="200" align="center" spry:sort="nombre">Nombre de Tasa</th>
									<th width="100" align="center" spry:sort="abreviado">Valor de la Tasa (%)</th>									
									<th width="50">&nbsp;</th>
								</tr>
							</thead>
							<tbody class="data">
								<tr class="RowData" spry:repeat="pvLista" spry:setrow="pvLista"
									...
									<td nowrap="nowrap"><span> 
									   <?php /* ?>
									           <a href="#"><img src="../img/bt_elimina.gif" width="14" height="14"
												title="Eliminar Registro" border="0" onclick="Eliminar('{numero}', '{nombre}');" /></a>
										<?php */ ?>		
									</span></td>
								</tr>
							</tbody>
 ...
 function btnNuevo_Clic()
  {
	...
	$("#divContent").css('display', 'none');
	var url = "man_parametros_edit.php?mode=<?php echo(md5("ajax_new"));?>&id=" ;
 ...
 function btnEditar_Clic(id)
  {
	...
	var url = "man_parametros_edit.php?action=<?php echo(md5("ajax_edit"));?>&id="+id ;
	loadUrlSpry("divContentEdit",url);
	$("#divContent").fadeOut("slow");
	$("#divContent").css('display', 'none');
 ...
 function CancelEdit()
 {
  ...
  function Eliminar(codigo,Descripcion)
  {
	...
	if(confirm("Estas seguro de eliminar el " + Descripcion))
	{
		...
		var sURL = "man_parametros_process.php?action=<?php echo(md5("ajax_del"))?>";
