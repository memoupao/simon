...
$objFunc->SetTitle("Mantenimiento de Perfiles");
$objFunc->SetSubTitle("Mantenimiento de Perfiles");
...
<script type="text/javascript">
	...
	{
		var xmlurl = "man.xml.php?action=<?php echo(md5("lista_perfiles"));?>";
		...
		{ 
			dsLista = new Spry.Data.XMLDataSet(xmlurl, "perfiles/rowdata", {useCache: false});
						...
						<table class="grid-table grid-width">
							<thead>
								<tr>
									...
									<th width="361" align="center" spry:sort="descripcion">Descripcion</th>
									<th width="198" align="center" spry:sort="abreviado">Abreviatura</th>
									<th width="129" align="center" spry:sort="numusuarios">Nro
										Usuarios</th>
									<th width="50">&nbsp;</th>
								</tr>
							</thead>
							<tbody class="data">
								<tr class="RowData" spry:repeat="pvLista" spry:setrow="pvLista"
									...
									<td align="center">{numusuarios}</td>
									<td nowrap="nowrap"><span> <a href="#"><img
							...
							<tfoot>
								<tr>
									...
									<th>&nbsp;</th>
									<th width="361">&nbsp;</th>
									<th width="198"><input type="button" class="Boton"
 ...
 function btnNuevo_Clic()
  {
	...
	$("#divContent").css('display', 'none');
	var url = "man_prf_edit.php?mode=<?php echo(md5("ajax_new"));?>&id=" ;
 ...
 function btnEditar_Clic(id)
  {
	...
	var url = "man_prf_edit.php?mode=<?php echo(md5("ajax_edit"));?>&id="+id ;
	loadUrlSpry("divContentEdit",url);
	$("#divContent").fadeOut("slow");
	$("#divContent").css('display', 'none');
 ...
 function CancelEdit()
 {
  ...
  function Eliminar(codigo,Descripcion)
  {
	...
	if(confirm("Estas seguro de eliminar el Registro \n" + Descripcion))
	{
		...
		var sURL = "man_prf_process.php?action=<?php echo(md5("ajax_del"))?>";
