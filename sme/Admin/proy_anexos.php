...
?>
     <div style="width: 750px; display: block;" align="right">
		...
		<div
			...
			<img src="../../../img/gestion.jpg" width="24" height="24" /><br />
			Refrescar
		</div>
	</div>
	<div id="divTableLista" class="TableGrid">
		<table width="750" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
               ...
               <?php /*if( $HC->Admin == $ObjSession->PerfilID )  { ?>
               <a href="#"><img src="../../../img/bt_elimina.gif"
							width="14" height="14" title="Eliminar Registro" border="0"
							onClick="EliminarAnexo('<?php echo($row['t02_cod_anx']);?>');" /></a>
               <?php } */ ?>
               </td>
            ...
            <tr>
					<td width="39" align="center" valign="middle"><span
						style="text-align: center; color: navy; font-weight: bold; font-size: 10px; cursor: pointer; width: 50px;">
							<input type="image" src="../../../img/aplicar.png" width="20"
							height="20" title="Guardar Anexo"
							onClick="Guardar_Anexo(); return false;" class="AnxProyectos" />
					</span></td>
		...
		<input type="hidden" name="t02_cod_proyecto" id="t02_cod_proyecto"
			value="<?php echo($id);?>" /> <input name="t02_version" type="hidden"
