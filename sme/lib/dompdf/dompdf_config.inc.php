 ...
 */
// ef("DOMPDF_PDFLIB_LICENSE", "your license key here");
...
/*
 * Optionally enable different classes of debug output before the pdf content. Visible if displaying pdf as text, E.g. on repeated display of same pdf in browser when pdf is not taken out of the browser cache and the premature output prevents setting of the mime type.
 */
def('DEBUGPNG', false);
