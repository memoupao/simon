...
$rowInf = $objInf->InformeMESeleccionarFecha($idProy, $idfecha);
$row = $objInf->InformeMESeleccionar($idProy, $rowInf['t30_id'], $rowInf['t30_ver_inf']);
				...
				<tbody class="data" bgcolor="#FFFFFF">
					<tr>
						<td align="left" valign="middle"><span class="ClassField">FECHA
								PRESENTACION DEL INFORME: </span> <span class="ClassText"><?php echo($row['t30_fch_pre']);?></span></td>
					</tr>
					<tr>
						<td align="left" valign="middle"><span class="ClassField">Avances</span>
							<br />
							<div class="ClassText"
								style="border: 1px solid #A0A0A4; padding: 5px;"><?php echo( nl2br($row['t30_avance']));?> </div>
						</td>
					</tr>
					<tr>
						<td align="left" valign="middle"><span class="ClassField">Logros</span><br />
							<div class="ClassText"
								style="border: 1px solid #A0A0A4; padding: 5px;"><?php echo( nl2br($row['t30_logros']));?> </div>
						</td>
					</tr>
					<tr>
						<td align="left" valign="middle"><span class="ClassField">Dificultades</span><br />
							<div class="ClassText"
								style="border: 1px solid #A0A0A4; padding: 5px;"><?php echo( nl2br($row['t30_dificul']));?> </div>
						</td>
					</tr>
					<tr>
						<td align="left" valign="middle"><br /> <span class="ClassField">Recomendaciones
								al Proyecto</span> <br />
							<div class="ClassText"
								style="border: 1px solid #A0A0A4; padding: 5px;"><?php echo( nl2br($row['t30_reco_proy']));?> </div>
						</td>
					</tr>
					<tr>
						<td align="left" valign="middle"><span class="ClassField">Recomendaciones
							...
							<div class="ClassText"
								style="border: 1px solid #A0A0A4; padding: 5px;"><?php echo( nl2br($row['t30_reco_fe']));?> </div>
						</td>
					</tr>
				</tbody>
				<tfoot>
