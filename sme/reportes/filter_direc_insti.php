...
.Filter .Button {
		...
		<div id="divBodyAjax" class="Filter">
			<fieldset>
				...
				<table width="90%" cellpadding="0" cellspacing="0">
					...
					<tbody>
						<tr>
							<td width="300" align="left" valign="middle" class="Field">Tipo
								de Institución<br />
							</td>
    ...
    ?>
							...
							<td width="337" rowspan="2" valign="middle">
								<button class="Button" onclick="NuevoReporte(); return false;"
									value="Nuevo">Buscar</button>
							</td>
						</tr>
						<tr>
							<td align="left" valign="middle"><span class="Field">Tipo de
									Relación</span>
							
							<td align="left" valign="middle"><select name="relacion"
								id="relacion" style="width: 130px" class="filterparams">
									<option value="*">Todos</option>
        <?php
        $rs = $objTablas->TipoRelacion();
        $objFunc->llenarCombo($rs, 'codigo', 'descripcion', $tipo);
        ?> 
      </select>
