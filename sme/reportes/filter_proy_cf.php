	...
	cursor: pointer;
		...
		<div id="divBodyAjax" class="Filter">
			<fieldset>
				...
				<input type='hidden' name='versionTxt' id='versionTxt'
...
$(document).ready(function(){
	var aVers = $('#versionTxt').val().trim();
	$('#poa').val( aVers ? aVers : '1' );
});
...
function NuevoReporte()
{
	...
	var aParams = ["idProy=" + $('#txtCodProy').val(), "idVersion=" + $('#poa').val()].join('&');
