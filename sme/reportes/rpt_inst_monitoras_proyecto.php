...
$rsInst = $objRep->InstitucionesMonitorasRepMonitorProy($concurso, $reg, $sector);
    ...
    if ($flag == 1) {
		...
		<tr bgcolor="#CCCCFF">
					...
					<tr style="color: #575757; background-color: #EAEAEA;">
						<td width="20%" colspan="4" align="center" valign="middle">Contacto</td>
						<td rowspan="2" height="33" colspan="1" align="center"
							valign="middle">Código del Proyecto</td>
						<td rowspan="2" width="50%" colspan="1" align="center"
							valign="middle">Nombre del Proyecto</td>
						<td rowspan="2" width="14%" colspan="1" align="center"
							valign="middle">Presupuesto Monitoreado</td>
					</tr>
					<tr style="color: #575757; background-color: #EAEAEA;">
						<td width="20%" colspan="1" align="center" valign="middle">Nombres</td>
						<td height="33" colspan="1" align="center" valign="middle">DNI</td>
						<td width="50%" colspan="1" align="center" valign="middle">Celular</td>
						<td width="14%" colspan="1" align="center" valign="middle">Mail</td>
					</tr>		  
		<?php
    }
    ?>
        ...
        <tr style="font-size: 11px;">
						...
						<td align="center" valign="top"><?php echo($row['celular']);?></td>
						<td align="center" valign="top"><?php echo($row['mail']);?></td>
						<td align="center" valign="top"><?php echo($row['t02_cod_proy']);?></td>
			...
			<div id="xlsCustom" style="display: none">
				<div class="TableGrid">
					<table width="896" align="center" cellpadding="0" cellspacing="0">
						<thead>
							<tr bgcolor="#CCCCFF">
								<td colspan="5"><strong>Datos Generales Institución</strong></td>
								<td colspan="4"><strong>Contacto</strong></td>
								<td rowspan="2"><strong>Código del Proyecto</strong></td>
								<td rowspan="2"><strong>Nombre del proyecto</strong></td>
								<td rowspan="2"><strong>Presupuesto Monitoreado</strong></td>
							</tr>
							<tr bgcolor="#CCCCFF">
...
while ($row = mysqli_fetch_assoc($rsInst)) {
    ?>
        ...
        <tr style="font-size: 11px;">
								...
								<td align="center" valign="top"><?php echo($row['t01_sig_inst']);?></td>
								<td align="center" valign="top"><?php echo($row['t01_nom_inst']);?></td>
								<td align="center" valign="top"><?php echo($row['institucion']);?></td>
								<td align="center" valign="top"><?php echo($row['t01_dire_inst']);?></td>
								<td align="center" valign="top"><?php echo($row['t01_ruc_inst']);?></td>
								<td align="center" valign="top"><?php echo($row['nombres']);?></td>
								<td align="center" valign="top"><?php echo($row['dni']);?></td>
								<td align="center" valign="top"><?php echo($row['celular']);?></td>
								<td align="center" valign="top"><?php echo($row['mail']);?></td>
