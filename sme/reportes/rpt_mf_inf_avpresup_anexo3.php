...
$idAnio = $objFunc->NumeroMesRev($rowInf['t51_per_fin'], 1);
$idMes = $objFunc->NumeroMesRev($rowInf['t51_per_fin'], 2);
...
$rowinst = $objEjec->EjecutorSeleccionar($IdFTE);
...
<?php if($IdFTE <> 10) { ?>
<caption>CONTRAPARTIDAS  -- <?php echo(strtoupper($institucion)); ?></caption>
<?php } ?>
  <thead>
    <?php
    $sumaTotal = 0;
    ...
    <tr style="background: #E6E6E6;">
						...
						<td width="79" rowspan="2" align="center" valign="middle">Presupuesto
							Aprobado <strong><?php echo($institucion);?></strong>
						</td>
						<td width="71" rowspan="2" align="center" valign="middle">Gasto
							Ejecutado Acumulado</td>
						<td colspan="16" align="center">Año de Ejecución</td>
						<td align="center">&nbsp;</td>
						<td align="center">&nbsp;</td>
						<td align="center">&nbsp;</td>
					</tr>
					<tr style="background: #E6E6E6;">
						...
						<td width="21" align="center">Trim 1</td>
						...
						<td width="21" align="center">Trim 2</td>
						...
						<td width="21" align="center">Trim 3</td>
						...
						<td width="21" align="center">Trim 4</td>
    ...
    $Index = 1;
    $objInformes = new BLMonitoreoFinanciero();
    $iRs = $objInformes->RepInforme_Financ_Anexo03($idProy, $idInforme, $IdFTE);
    ...
    <tr class="<?php echo($tipo);?>">
						...
						<td align="right" style="color: #FFF; background-color: #336;"><?php echo( number_format($row['t1'],2));?></td>
						...
						<td align="right" style="color: #FFF; background-color: #336;"><?php echo( number_format($row['t2'],2));?></td>
						...
						<td align="right" style="color: #FFF; background-color: #336;"><?php echo( number_format($row['t3'],2));?></td>
						...
						<td align="right" style="color: #FFF; background-color: #336;"><?php echo( number_format($row['t4'],2));?></td>
    ...
    ?>
				...
				<tbody class="data">
					<tr style="font-size: 11px;" class="RowSelected";>
						...
						<td align="right" style="background-color: #DCD1FA;"><?php echo( number_format($arrTotales['t1'],2));?></td>
						...
						<td align="right" style="background-color: #DCD1FA;"><?php echo( number_format($arrTotales['t2'],2));?></td>
						...
						<td align="right" style="background-color: #DCD1FA;"><?php echo( number_format($arrTotales['t3'],2));?></td>
						...
						<td align="right" style="background-color: #DCD1FA;"><?php echo( number_format($arrTotales['t4'],2));?></td>
