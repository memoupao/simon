						...
						<td valign="middle">
							<fieldset id="proyecto" style="font-size: 10px;">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="2"
									class="TableEditReg">
									<tr>
										<td width="105" height="21" align="left" valign="middle"><strong>Proyecto

										</strong></td>
										<td colspan="2" align="left" valign="bottom" nowrap="nowrap">
											<input name="txtCodProy" type="text" id="txtCodProy"
											size="16" style="text-align: center;" readonly="readonly"
											...
											value="<?php echo( $row['t01_nom_inst']);?>" />
										</td>
									</tr>
									<tr>
										<td height="35" align="left" valign="middle"><strong>Titulo
										...
										<td colspan="2" align="left" valign="middle" nowrap="nowrap"><textarea
												...
												id="txtNomproyecto"><?php echo($row['t02_nom_proy']);?></textarea>
											<strong> <input name="cboversion" type="hidden"
												id="cboversion" value="1" /> <input name="txtidInst"
												type="hidden" id="txtidInst"
												value="<?php echo($row['t01_id_inst']);?>" />
										</strong></td>
									</tr>
									<tr>
										<td height="23" align="left" valign="middle" nowrap="nowrap"><strong>Informe
												MF.</strong></td>
										<td width="226" align="left" valign="middle" nowrap="nowrap">
											<select name="cboInforme" id="cboInforme"
											style="width: 220px;">
												<option value="" selected="selected"></option>
                          <?php
                        $idInf = $_POST['idInforme'];
                        $objFinanc = new BLMonitoreoFinanciero();
                        $Rs = $objFinanc->Inf_MF_Listado($row['t02_cod_proy']);
                        ...
                        ?>
										...
										<td width="286" rowspan="2" align="right" valign="middle"
											nowrap="nowrap"><span class="Button">
												<button onclick="NuevoReporte(); return false;"
													value="Nuevo">Ver Reporte</button>
										</span></td>
									</tr>
									<tr>
										<td height="30" valign="middle" nowrap="nowrap"><strong>
												Fuente Financ.</strong></td>
...
function NuevoReporte()
{
	var arrayControls = new Array();
		...
		arrayControls[1] = "idInforme=" + $('#cboInforme').val();
...
{
	var sURL = "<?php echo(constant("PATH_SME")."monitoreofe/informes/");?>inf_financ_process.php?action=<?php echo(md5("ajax_lista_informes_mf_financ"))?>" ;
