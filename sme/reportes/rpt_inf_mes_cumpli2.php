...
// $rowInf = $objInf->InformeMensualSeleccionar($idProy, $idAnio, $idMes, $vers);

$rsDet = $objInf->RptCumplimientoFinanc_mes($idProy, $idAnio, $idMes);
// sp_rta_cump_inf_financ_mes
?>
...
<div id="divBodyAjax" class="TableGrid">
			...
			<table width="95%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td width="7%" align="center"><?php echo("Mes ".$idMes);?></td>
					<th width="24%">&nbsp;</th>
			...
			<table width="73%" align="center" cellpadding="0" cellspacing="0">
				<thead>
					<tr>
						...
						<td width="11%" align="center" valign="middle">META</td>
						<td width="12%" align="center" valign="middle">PRESUPUESTO</td>
						<td width="11%" align="center" valign="middle">GASTO</td>
    ...
    <tr style="font-size: 11px;">
						...
						<td align="center" valign="top"><?php echo($row['um']);?>&nbsp;</td>
						<td align="center" valign="top"><?php echo($row['meta']);?>&nbsp;</td>
						<td align="center" valign="top"><?php echo($row['presupuesto']);?>&nbsp;</td>
						<td align="center" valign="top"><?php echo($row['gasto']);?>&nbsp;</td>
						<td align="right" valign="top"><?php echo( number_format($row['cumplimiento'],2)." %");?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					</tr>
    <?php
            $Index ++;
        }
