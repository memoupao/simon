...
.Filter .Button {
	...
	<?php
$aCon = $objFunc->__Request('cboConcurso');
$aEje = $objFunc->__Request('cboEjecutor') ? $objFunc->__Request('cboEjecutor') : $objFunc->__Request('cboInstitucion');
?>

	$(document).ready(function(){
		$('#cboConcurso').val("<?php echo $aCon; ?>");
		$('#cboEjecutor').val("<?php echo $aEje; ?>");
	});
