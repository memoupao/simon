		...
		<table width="516" align="center" class="TableEditReg">
			...
			<tr valign="baseline">
				<td height="25" colspan="4" align="left" valign="middle"
					...
					size="4" maxlength="5" disabled="disabled"
					style="text-align: center;" /> <input name="t09_sub" type="text"
...
$suma = $suma + $rowFTE["mtofinan"];
	  ...
	  function GuardarFTE()
	  {
		 ...
		 var sURL = "poa_fin_process.php?action=<?php echo(md5("guardar_fuentes_financ_cost_ope"))?>" ;
		 var req = Spry.Utils.loadURL("POST", sURL, true, MySuccessGuardarFTE, { postData: BodyForm, headers: { "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8" }, errorCallback: onErrorLoad });
