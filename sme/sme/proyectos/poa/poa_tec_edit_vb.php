...
?>
			...
			<div id="toolbar" style="height: 4px;" class="BackColor">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
    					...
    					<td>
    					<?php if($isSE || $IsMF){?>
    				    <input type="checkbox" id="vb_se" name="vb_se" <?php echo($row['vb_se_tec']==1?'checked':'');?> <?php echo($IsMF?'disabled':'');?>/>V°B° SE
    			        <?php }?>
	    ...
	    function GuardarPOA()
	    {
        	...
        	var sURL = "poa_tec_process.php?action=<?php echo(md5("ajax_edit"));?>";
    	...
    	<?php if($ObjSession->PerfilID == $objHC->SE) { ?>
			  $('#t02_estado option[value="'+Correccion+'"]').removeAttr('disabled');
        <?php } ?>
