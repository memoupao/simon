...
<div id="toolbar" style="height: 4px;">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="15%"><button class="Button"
							onclick="NuevoGastFunc(); return false;" value="Nuevo">Nueva
							Partida</button></td>
					<td width="14%"><button class="Button"
							onclick="NuevoGastFunc_Costeo(); return false;"
							value="Recargar Listado">Nuevo Gasto</button></td>
					<td width="15%"><button class="Button"
		...
		<div id="divTableLista" class="TableGrid">
			...
			<table width="780" border="0" cellpadding="0" cellspacing="0">
				...
				<tr class="SubtitleTable"
					...
					<td width="18" align="center" style="border: solid 1px #CCC;"
						colspan="2">&nbsp;</td>
    ...
    if ($iRs->num_rows > 0) {
        ...
        <tr class="RowData" style="background-color: #E3FEE0;">
						<td nowrap="nowrap" style="padding: 1px;"><span> <a
								href="javascript:"><img src="../../../img/pencil.gif" alt=""
						...
						<td width="67" align="right"><?php echo(number_format($row["ejecutor"],2));?></td>
						<td width="61" align="right"><?php echo(number_format($row["otros"],2));?></td>

						<td nowrap="nowrap" style="padding: 1px;" colspan="2">&nbsp;
   	    ...
   	    <tr class="RowData" style="background-color: #FFF; color: #036;">
						...
						<td width="67" align="right"><?php echo(number_format($rowcateg["ejecutor"],2));?></td>
						<td width="61" align="right"><?php echo(number_format($rowcateg["otros"],2));?></td>
            ...
            <?php
                ...
                while ($rowgasto = mysqli_fetch_assoc($iRsGasto)) {
                    $totalFuentes = $rowgasto["fte_fe"] + $rowgasto["ejecutor"] + $rowgasto["otros"];
                    $style = number_format($totalFuentes, 2) != number_format($rowgasto["total"], 2) ? 'style="background-color:#FF0;color:#F00; text-decoration:blink;"' : '';
                    ?>
                   <tr class="RowData" style="background-color: #FFF;">
						...
						<td align="center">&nbsp;</td>
						<td align="right"><font <?php echo($style);?>><?php echo( number_format(($rowgasto["total"]),2));?></font></td>
						<td width="72" align="right"><?php echo(number_format($rowgasto["fte_fe"],2));?></td>
						<td width="67" align="right"><?php echo(number_format($rowgasto["ejecutor"],2));?></td>
						<td width="61" align="right"><?php echo(number_format($rowgasto["otros"],2));?></td>
						<td align="center" style="padding: 1px;"><a href="#"><img
								src="../../../img/financ.gif" alt="" width="16" height="16"
								border="0" title="Agregar o Modificar Fuentes de Financiamiento"
								onclick="LoadGastoFuncionFTE('<?php echo($rowgasto["idpartida"]);?>', '<?php echo($rowgasto["idgasto"]);?>'); return false;" /></a></td>
						<td align="center" nowrap="nowrap"><span> <a href="javascript:"><img
									src="../../../img/bt_elimina.gif" alt="" width="11" height="12"
									border="0" title="Eliminar Registro"
