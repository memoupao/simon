...
#txtFileUploadTDR {
        ...
        ?>
							...
							<tr valign="baseline">
								...
								<td align="left"><input name="t03_dedica" type="text"
									id="t03_dedica" class="roundDec"
									value="<?php echo(number_format($row["t03_dedica"], 2));?>"
								...
								<td align="left"><input name="t03_perma" type="text"
									id="t03_perma" value="<?php echo($row["t03_perma"]);?>"
									size="20" maxlength="5" style="text-align: center" /></td>
								<td align="left">&nbsp;</td>
								<td align="left">&nbsp;</td>
							</tr>
							<tr valign="baseline">
			...
			<div id="divShowTDR">
													<span
														style="cursor: pointer; font-weight: bold; color: #990; font-size: 11px; text-decoration: underline;"
                  ...
                  <tr class="RowData">
                       ...
                       <?php echo($rowMeta['anio']); ?>
														...
														<td align="center" valign="middle"><input
															...
															onclick="TotalMesesactivados('<?php echo($rowMeta['t02_anio']);?>');"
									...
									<table width="100%" border="0" cellspacing="1" cellpadding="0"
										...
										<tr>
											<td align="center"><input name="t03_per_rem_mes" type="text"
												id="t03_per_rem_mes" value="<?php echo($row["t03_mta"]);?>"
												size="12" readonly="readonly" style="text-align: center" /></td>
											<td align="center"><input name="t03_per_grati" type="text"
												id="t03_per_grati" value="<?php echo($row["t03_mta"]);?>"
												size="12" readonly="readonly" style="text-align: center" /></td>
											<td align="center"><input name="t03_per_essalud" type="text"
												id="t03_per_essalud" value="<?php echo($row["t03_mta"]);?>"
												size="12" readonly="readonly" style="text-align: center" /></td>
											<td align="center"><input name="t03_per_cts" type="text"
												id="t03_per_cts" value="<?php echo($row["t03_mta"]);?>"
												size="12" readonly="readonly" style="text-align: center" /></td>
											<td align="center"><input name="t03_per_prom_mes" type="text"
												id="t03_per_prom_mes" value="<?php echo($row["t03_mta"]);?>"
												size="15" readonly="readonly" style="text-align: center" /></td>
											<td align="center"><input name="t03_per_gas_tot" type="text"
												id="t03_per_gas_tot" value="<?php echo($row["t03_mta"]);?>"
												size="15" readonly="readonly" style="text-align: center" /></td>
										</tr>
									</table>
								</td>
  ...
  function Guardar_Personal()
	...
	<?php $ObjSession->AuthorizedPage(); ?>
	 ...
	 var sURL = "mp_personal_process.php?action=<?php echo($view);?>" ;
	...
	function AdjuntarTDR()
	{
		...
		if(strFile!="")
		{
			...
			if(allowSubmit)
			{
				 var urlPost = "mp_personal_process.php?action=<?php echo(md5('ajax_save_TDR'));?>" ;
