 ...
 <script src="../../../jquery.ui-1.5.2/jquery.numeric.js"
						...
						<table width="516" align="center" class="TableEditReg">
							...
							<tr valign="baseline">
								...
								<td colspan="5" align="left" valign="middle" nowrap="nowrap"><input
									...
									id="t09_sub" value="<?php echo($row["t09_sub"]);?>" size="70"
        ...
        ?>
							...
							<tr>
								...
								<td width="79" align="left" valign="middle"><input name="t10_cu"
									...
									value="<?php echo($rowCosteo["t10_cu"]);?>" size="12" /></td>
								...
								<td valign="middle"><input name="t10_cant" type="text"
									...
									style="text-align: center;" onkeyup="TotalizarPresup();"
									value="<?php echo($rowCosteo["t10_cant"]);?>" size="10" /></td>
							...
							<tr>
								...
								<td align="left" valign="middle"><input name="t09_meta"
									...
									style="text-align: center"
									value="<?php echo($row["t09_mta"]);?>" size="12"
  ...
  function Guardar_CostoOperativo()
	...
	<?php $ObjSession->AuthorizedPage(); ?>
	 ...
	 var sURL = "cost_ope_process.php?mode=<?php echo($view);?>&action=<?php echo(md5("guardar_costo_operativo"))?>" ;
	 var req = Spry.Utils.loadURL("POST", sURL, true, MySuccessGuardarCostoOperativo, { postData: BodyForm, headers: { "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8" }, errorCallback: onErrorCosteo });
	 return false;
	}
  ...
  $('.costosoperativos:input[readonly="readonly"]').css("background-color", "#eeeecc") ;
