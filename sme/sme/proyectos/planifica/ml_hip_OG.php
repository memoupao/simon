...
$rHip = $objML->ListadoSupuestosOG($idProy, $idVersion);
$row_rsSupuestos = mysql_fetch_assoc($rHip); // Recuperamos el primer registro

$objML = NULL; // Liberamos recursos

$urlEdicion = "ml_hip_OG_edit.php?idProy=$idProy&idVersion=$idVersion";
...
<?php
$objFunc->SetSubTitle("Supuestos de Proposito");
?>
					...
					<div class="TableGrid">
                      ...
                      <?php do { ?>
                        <tr class="RowData">
						  ...
						  <?php if($row_rsSupuestos['t07_cod_prop_sup']>0 && !$modificar) { ?>
							<a href="#"><img src="../../../img/b_edit.png" width="14"
													height="14" title="Editar Registro" border="0"
													onclick="Editar('<?php echo $row_rsSupuestos['t07_cod_prop_sup']; ?>');" /></a>
						  <?php } ?>
						  </span></td>
										<td width="40" nowrap="nowrap"><?php echo $row_rsSupuestos['t07_cod_prop_sup']; ?></td>
										<td align="left"><?php echo($row_rsSupuestos['t07_sup']); ?></td>
										<td width="20" align="left">
                          <?php /* if($row_rsSupuestos['t07_cod_prop_sup']>0 && !$modificar) { ?>
                            <a href="#"><img
												src="../../../img/b_drop.png" width="14" height="14"
												title="Eliminar Registro" border="0"
												onclick="Eliminar('<?php echo $row_rsSupuestos['t07_cod_prop_sup']; ?>', '<?php echo $row_rsSupuestos['t07_sup']; ?>');" /></a>													 
						  <?php } */ ?>
                          </td>
									</tr>
