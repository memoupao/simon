...
$objFunc->SetTitle("V°B° Informe de Entregable");
$objFunc->SetSubTitle("V°B° Informe de Entregable");
$objHC = new HardCode();
...
<head>
    ...
    <script type="text/javascript">
    	...
    	{
    		var xmlurl = "inf_entregable_process.xml.php?action=<?php echo(md5("lista_inf_entregable_vb"));?>";
    	...
    	<div id="mainContent">
    		<form id="FormData" method="post" enctype="application/x-www-form-urlencoded" action="<?php echo($_SERVER['PHP_SELF']);?>">
                ...
                <div id="divContent" style="font-family: Arial, Helvetica, sans-serif; padding-left: 5px; padding-right: 3px;">
					...
					<div class="TableGrid" spry:region="pvLista">
						...
						<table class="grid-table grid-width">
							<thead>
								<tr>
									<th height="20" nowrap="nowrap" width="30">&nbsp;</th>
							...
							<tbody class="data">
								<tr class="RowData" spry:repeat="pvLista" spry:setrow="pvLista" id="{@id}" spry:select="RowSelected">
									<td>
                                        <a href="#">
                                            <img src="../../../img/pencil.gif" width="14" height="14" title="Editar Registro" border="0" onclick="btnEditar_Clic('{proy}', '{version}','{t25_anio}','{t25_entregable}'); return false;" />
                                        </a>
                                    </td>
				...
				<script language="JavaScript" type="text/javascript">
                    function btnEditar_Clic(proy, version, anio, entregable)
                    {
                        var url = "inf_entregable_edit_vb.php?mode=<?php echo(md5("ajax_edit"));?>&idProy="+proy+"&anio="+anio+"&idEntregable="+entregable+"&idVersion="+version;
