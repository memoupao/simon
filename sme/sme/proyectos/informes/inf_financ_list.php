...
<?php
$objFunc->SetTitle("Informe Financiero - Proyectos");
$objFunc->SetSubTitle("Informe Financiero");

$objHC = new HardCode();

switch ($ObjSession->PerfilID) {
    case $objHC->Ejec:
        $res_editar = "'{est_eje}' == 'Elaboración' || '{est_eje}' == 'Corrección'";
        $res_ver = "'{est_eje}' == 'Elaboración' || '{est_eje}' == 'Corrección' || '{est_eje}' == 'V°B°'";
        $res_elim = "'{est_eje}' == 'Elaboración'";
        break;
    case $objHC->SE:
    case $objHC->GP:
    case $objHC->RA:
    ...
    case $objHC->FE:
        ...
        $res_ver = "'{est_eje}' == 'Elaboración' || '{est_eje}' == 'Corrección' || '{est_eje}' == 'V°B°' || '{est_eje}' == 'Revisión'";
        $res_elim = "'{est_eje}' == 'Elaboración' || '{est_eje}' == 'Corrección' || '{est_eje}' == 'V°B°' || '{est_eje}' == 'Revisión'";
        break;
}
...
?>
 ...
 function btnEditar_Clic(anio, mes)
  {
	var url = "inf_financ_edit.php?mode=<?php echo(md5("ajax_edit"));?>&idProy="+$('#txtCodProy').val()+"&idanio="+anio+"&idmes="+mes;
	loadUrlSpry("divContentEdit",url);
	$("#divContent").fadeOut("slow");
	$("#divContent").css('display', 'none');
