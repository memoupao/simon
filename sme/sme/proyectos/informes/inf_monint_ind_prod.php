...
?>
        ...
        <div id="divTableLista">
			<table width="950" cellpadding="0" cellspacing="0" class="TableEditReg">
                ...
                $iRs = $objInf->listarIndicadoresProdSI($idProy, $idVersion, $idComp, $idProd, $anio, $idEntregable);
                $RowIndex = 0;
                if ($iRs->num_rows > 0) {
                    ...
                    <?php
                        $caracteristicas = $objInf->listarCaracteristicasIndProdSI($idProy, $idVersion, $idComp, $idProd, $row['t09_cod_act_ind'], $anio, $idEntregable);
                        $k = 0;
            ...
            function Guardar_AvanceIndProd()
            {
                ...
                {
                    var sURL = "inf_monint_process.php?action=<?php echo(md5('ajax_indicadores_prod'));?>";
