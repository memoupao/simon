...
<?php
$objFunc->SetTitle("Sectores Productivos - Proyectos");
$objFunc->SetSubTitle("Sectores Productivos");
?>
<!-- InstanceEndEditable -->
...
{
	var codigo = $("#txtCodProy").attr("value");

	var long = $("#txtCodProy").length;
...
function ExportarSectorProyecto()
	{
      ...
      <fieldset id="proyecto">
								...
								<table width="86%" border="0" cellpadding="0" cellspacing="2"
									...
									<tr>
										...
										<td width="329" align="left" valign="middle"><input
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="31%"><button class="Button"
										onclick="ExportarSectorProyecto(); return false;"
...
function LoadDataGrid(idProy)
{
	...
	var url = "sect_prod_edit.php?mode=<?php echo(md5("ajax_list"));?>&idProy="+idProy;
