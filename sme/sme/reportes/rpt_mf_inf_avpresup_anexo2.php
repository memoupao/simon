...
<div id="divBodyAjax" class="TableGrid">
			...
			<table width="950" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td colspan="8" align="center" valign="middle"><span
						class="ClassField" style="text-transform: uppercase;">RESUMEN DEL EXCEDENTE POR EJECUTAR     AL <?php echo($objFunc->FechaLarga($rowInf['t51_cor_ctb']));?></span></td>
				</tr>
				<tr>
					<td colspan="8" align="center" valign="middle"><span
			...
			<table width="950" cellpadding="0" cellspacing="0">
				...
				<tbody class="data">
					<tr>
						<td colspan="2" align="left" nowrap="nowrap"><?php echo($objFunc->FechaLarga($rowInf['t51_cor_ctb']));?></td>
						<td align="right"><?php echo(number_format($rowInf['t51_caja'],2));?></td>
						<td align="right"><?php echo(number_format($rowInf['t51_bco_mn'],2));?></td>
						<td align="right"><?php echo(number_format($rowInf['t51_ent_rend'],2));?></td>
						<td align="right"><?php echo(number_format($rowInf['t51_cxc'],2));?></td>
						<td align="right"><?php echo(number_format($rowInf['t51_cxp'],2));?></td>
						<td align="right"><?php echo(number_format($rowInf['t51_exc'],2));?></td>
					</tr>
					<tr>
				...
				<tbody class="data">
					<tr>
						...
						<td align="right" bgcolor="#E8E8E8">&nbsp;</td>
						<td align="right" bgcolor="#E8E8E8">&nbsp;</td>
						<td align="right" bgcolor="#E8E8E8"><?php echo(number_format($rowInf['t51_exc'],2));?></td>
					</tr>
				</tbody>
			</table>
			<p>
