...
.Filter .Button {
	...
	cursor: pointer;
		...
		<div id="divBodyAjax" class="Filter">
			<fieldset>
				<legend>Busqueda de Concursos</legend>
				<table width="90%" cellpadding="0" cellspacing="0">
					<thead>
					</thead>
					<tbody>
						<tr>
							<td width="118" align="left" valign="middle" class="Field">Concurso<br /></td>
        ...
        ?>
						...
						<tr>
							<td align="left" valign="middle"><span class="Field">Estado</span>
