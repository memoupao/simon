...
<div id="divBodyAjax" class="TableGrid">
			...
			<table width="90%" align="center" cellpadding="0" cellspacing="0">
				<thead>
					<tr>
						<td width="21%" height="33" align="center" valign="middle">Sector</td>
						<td width="21%" height="33" align="center" valign="middle">Sub Sector</td>
						<td width="17%" align="center" valign="middle">Producto Principal</td>
						<td width="30%" align="center" valign="middle">Producto Promovido</td>
					</tr>
				</thead>
    ...
    $Index = 1;
    while ($row = mysqli_fetch_assoc($rsSector)) {
        
        ?>
    			<tr style="font-size: 11px;">
					<td align="left" valign="middle"><?php echo($row['sector_main']);?></td>
					<td align="left" valign="middle"><?php echo($row['sector']);?></td>
					<td align="left" valign="middle"><?php echo($row['subsector']);?></td>
					<td align="left" valign="middle"><?php echo($row['t02_obs']);?></td>
				</tr>
    <?php
        $Index ++;
    } // /End While
