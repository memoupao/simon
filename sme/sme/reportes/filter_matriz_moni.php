...
.Filter .Button {
	...
	cursor: pointer;
        ...
        ?>
							...
							<td width="95" align="left" valign="middle" class="Field">Región</td>
        ...
        ?>
							...
							<td width="247" align="left" valign="middle">&nbsp;</td>
						</tr>
						<tr>
        ...
        ?>
						...
						<tr>
							<td height="23" align="left" valign="middle" nowrap="nowrap"
								class="Field">Supervisor Externo</td>
							<td align="left" valign="middle"><select name="cboMoniExt"
								id="cboMoniExt" style="width: 180px" class="filterparams">
									<option value="*">Todos</option>
        <?php
        $rs = $objEjec->ListadoRespCargo(60);
        $objFunc->llenarComboGroupI($rs, 'codigo', 'nombres', $objFunc->__Request("cboMoniExt"), 'tipo');
        ?>
      </select></td>
							<td align="left" valign="middle">&nbsp;</td>
							<td align="left" valign="middle" nowrap="nowrap" class="Field">Estado</td>
							<td align="left" valign="middle"><select name="cboEstado"
								id="cboEstado" style="width: 130px" class="filterparams">
									<option value="*">Todos</option>
        <?php
        ...
        ?>
						...
						<tr>
							...
							<td colspan="7" align="left" valign="middle"><input
								...
								style="text-align: center;" value="" class="filterparams" /></td>
						</tr>
					</tbody>
					<tfoot>
					</tfoot>
