...
.rotate90 {
	...
	filter: progid:DXImageTransform.Microsoft.BasicImage(rotation=3);
      ...
      (<?php echo($objFunc->MonthName($MesIni)." ".$AnioIni." - ".$objFunc->MonthName($MesFin)." ".$AnioFin); ?>)
					...
					<tr>
						...
						<td width="67" align="center" valign="middle">Trim. Desemb</td>
    ...
    foreach ($arr_concursos as $conc) {
            ...
            if ($conc == $arrValues['concurso'][$y] && $cod_proy != $last_proy) {
                ...
                for ($z = 0; $z < count($arrValues['t60_id_desemb']); $z ++) {
                    ...
                    if ($conc == $arrValues['concurso'][$z] && $cod_proy == $arrValues['codigo'][$z]) {
                        ...
                        echo ($newTR);
                        ?>
                          <td align="center" valign="middle">Trim&nbsp;<?php echo($arrValues['t60_id_trim'][$z]); ?></td>
        ...
        ?>
          <tr>
						<td colspan="9" align="center" style="color: #036">Total Desembolsado en el Periodo del Concurso <?php echo($conc);?><br />
						</td>
