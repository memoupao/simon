...
$irs = $objFE->RepDesembolsos_Periodo($idconcurso, $Ejecutor, $inicio, $termino);
	...
	filter: progid:DXImageTransform.Microsoft.BasicImage(rotation=3);
				...
				<thead>
					<tr>
						...
						<td colspan="2" align="center" valign="middle"><p align="center">Periodo
								del Proyecto</p></td>
						<td height="20" colspan="8" align="center" valign="top">
      ...
      (<?php echo($objFunc->MonthName($MesIni)." ".$AnioIni." - ".$objFunc->MonthName($MesFin)." ".$AnioFin); ?>)
					...
					<tr>
						...
						<td width="67" align="center" valign="middle">Entregable</td>
						<td width="67" align="center" valign="middle">Periodo</td>
            ...
            if ($conc == $arrValues['concurso'][$y] && $cod_proy != $last_proy) {
                ...
                for ($z = 0; $z < count($arrValues['t60_id_desemb']); $z ++) {
                    ...
                    if ($conc == $arrValues['concurso'][$z] && $cod_proy == $arrValues['codigo'][$z]) {
                        ...
                        echo ($newTR);
                        ?>
                        <td align="center" valign="middle">Nro. &nbsp;<?php echo($arrValues['t60_id_trim'][$z]); ?></td>
                        <td align="center" valign="middle">PeriodoZ</td>
						<td align="left" valign="middle"><?php echo($arrValues['tipopago'][$z]); ?><br /></td>
