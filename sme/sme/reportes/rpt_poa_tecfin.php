...
?>
	...
	<table width="800" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td align="left" style="font-size: 11px; text-align: justify;">
				<?php echo(nl2br($row["t02_punto_aten"]));?>
			</td>
				</tr>
				<tr>
				...
				<tr>
					<td align="left" style="font-size: 11px; text-align: justify;">
				<?php echo(nl2br($row["t02_politica"]));?>
			</td>
				</tr>
				<tr>
				...
				<tr>
					<td align="left" style="font-size: 11px; text-align: justify;">
				<?php echo(nl2br($row["t02_benefic"]));?>
			</td>
				</tr>
				<tr>
				...
				<tr>
					<td align="left" style="font-size: 11px; text-align: justify;">
				<?php echo(nl2br($row["t02_otras_interv"]));?>
			</td>
				</tr>
			</table>
    ...
    while ($row = mysqli_fetch_assoc($iRs)) {
        ...
        if ($tipo == "componente") {
			...
			<tr style="border: solid 1px #CCC; background-color: #eeeeee;">
						<td height="15" colspan="5" align="left" valign="middle"><strong><?php echo($row['codigo'].".- ".nl2br($row['indicador']));?></strong>
						</td>
					</tr>
					<tr style="border: solid 1px #CCC; background-color: #eeeeee;">
		...
		<?php
			...
			<tr style="border: solid 1px #CCC; background-color: #eeeeee;">
						<td width="329" rowspan="2" align="left" valign="middle"
							bgcolor="#FFFFFF">
					<?php echo($row['codigo'].".- ".nl2br($row['indicador']));?>
			...
			<tr style="background-color: #FFF;">
							<td colspan="12" align="left" valign="middle"
								...
								<div style="display: inline-block;">
									<strong>Componente <?php echo " ".$rowCO['t08_cod_comp'];	?>:</strong>
								</div>
								<div style="display: inline-block;"><?php echo $rowCO['t08_comp_desc']; ?></div>
							</td>
						</tr>
		<?php
    $objML = new BLMarcoLogico();
    ...
    while ($rowAct = mysql_fetch_assoc($rs)) {
        ?>
			<tr style="border: solid 1px #CCC; background-color: #DAF3DD;">
					...
					<?php echo($rowCO['t08_cod_comp'].".".$rowAct['t09_cod_act']); ?>
				</td>
							<td height="15" colspan="11" align="left" valign="middle"><strong><?php echo($rowAct['t09_act']);?></strong>
							</td>
						</tr>
		<?php
        ...
        while ($row = mysqli_fetch_assoc($iRs)) {
			...
			<tr class="RowData"
							...
							<td width="44" align="center" valign="middle" bgcolor="#F2F7B9"><?php echo(number_format($row['meta_poa']));?></td>
...
?>
							...
							<tbody class="data" bgcolor="#FFFFFF">
								<tr class="SubtitleTable"
									...
									<td height="22" colspan="3" align="left" valign="middle"><strong>Archivos
											Adjuntos al Plan Operativo - Especificación Técnica</strong>
									</td>
								</tr>
								<tr>
					<?php
    ...
    if ($iRs->num_rows > 0) {
        while ($row = mysqli_fetch_assoc($iRs)) {
            ...
            ?>
						<td width="791" height="30" align="center" valign="top">
							<?php echo ($file_vista); ?><br>
...
echo number_format($totalEjecutado + $costoPersonal + $costoEquipa + $costoFunc + $costoAdm + $costoImprev, 2);
    ?>
						...
						<td>
					<?php echo number_format($aCostosDirectos + $aAdmisCostoTotal +
											 $rowLB['imprevistos'] + $LineaBase, 2); ?>
				</td>
						<td>
					<?php echo number_format(($costoDirecInicial - ($totalEjecutado + $costoPersonal +
																	$costoEquipa + $costoFunc) -
        									  $aCostosDirectos + (($costoAdminist + $imprevistosInicialReal +
        									  					   $lineaBaseInicial) -
        															($costoAdm + $costoImprev) -
        															($aAdmisCostoTotal + $rowLB['imprevistos'] + $LineaBase))), 2); ?>
        		</td>
					</tr>
				</tfoot>
			</table>
