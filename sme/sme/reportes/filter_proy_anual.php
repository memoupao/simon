...
$idAnio = $objFunc->__POST('idAnio') ? $objFunc->__POST('idAnio') : $objFunc->__POST('anio');
...
?>
  <tr>
						<td align="left" valign="middle" class="Field">Año</td>
		...
		<?php for($i = 1; $max>$i ; $i++){ ?>
		 ...
		 <?php } ?>
				...
				<input type='hidden' name='anioTxt' id='anioTxt'
...
function NuevoReporte()
{
	...
	var aParams = ["idProy=" + $('#txtCodProy').val(), "anio=" + $('#poa').val()].join('&');
