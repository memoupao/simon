...
<?php
$objFunc->SetTitle("Cronograma de Visitas - Supervisión Interna");
$objFunc->SetSubTitle("Supervisión Interna - Cronograma de Visitas");
?>
<!-- InstanceEndEditable -->
	...
	-->
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="31%"><button name="btnRefrescar" value="Refrescar"
...
function LoadDataGrid(idProy)
{
	...
	var url = "cron_visita_mi_edit.php?mode=<?php echo(md5("ajax_list"));?>&idProy="+idProy;
