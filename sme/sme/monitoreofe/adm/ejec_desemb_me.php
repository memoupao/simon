...
$objFunc->SetTitle("Ejecución de Desembolsos ME - Administracion");
$objFunc->SetSubTitle("Ejecución de Desembolsos Monitor Externo");
            ...
            ?>
										...
										<td width="59" align="center" valign="middle" id="toolbar"><span>
												<button name="btnRefrescar" value="Refrescar"
													class="Button, Readonly" id="btnBuscar"
...
{
	var url = "ejec_desemb_me_lista.php?mode=<?php echo(md5("ajax_list"));?>&cboconcurso="+$("#cboconcurso").val() + "&cboinstitucion=" + $("#cboinstitucion").val() ;
