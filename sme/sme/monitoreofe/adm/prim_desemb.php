...
$objFunc->SetTitle("Aprobación para Primer Desembolso - Monitoreo Financiero");
$objFunc->SetSubTitle("Aprobación para Primer Desembolso");
		...
		<div id="mainContent">
            ...
            ?>
										...
										<td width="59" align="center" valign="middle" id="toolbar"><span>
												...
												<br />
											<button name="btnExportar" value="Exportar" class="Button"
													id="btnExportar" onclick="Exportar(); return false;">Exportar</button>
										</span></td>
									</tr>
								</table>
  ...
  function Exportar()
{
		 ...
		 arrayControls[1] = "cboinstitucion=" + $("#cboinstitucion").val();
...
{
	var url = "prim_desemb_lista.php?mode=<?php echo(md5("ajax_list"));?>&cboconcurso="+$("#cboconcurso").val() + "&cboinstitucion=" + $("#cboinstitucion").val() ;
