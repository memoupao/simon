...
$objFunc->SetTitle("Control de Pago a Supervisores Externos - Administracion");
$objFunc->SetSubTitle("Control de Pago a Supervisores Externos");
    ...
    <?php include("../../../includes/subtitle.php");?>
		...
		<div id="mainContent">
            ...
            ?>
										...
										<td width="20%" align="left" valign="middle" id="toolbar">
...
{
	var url = "ctrl_pag_me_lista.php?mode=<?php echo(md5("ajax_list"));?>&cboconcurso="+$("#cboconcurso").val() + "&cboinstitucion=" + $("#cboinstitucion").val() ;
