-- --------------------------------------------------------------------------------
-- DA, V2.1
-- RF-004 - Informe de Supervisión - Registro de Análisis del Avance Físico y Presupuestal
-- por cada Indicador de Producto.
-- --------------------------------------------------------------------------------



ALTER TABLE `t09_prod_ind_inf_se` ADD COLUMN `t09_avancefisicopres` TEXT NULL  AFTER `t09_partbenef`;
...
BEGIN
    SELECT ind.t08_cod_comp,
		...
		inf.t09_avancefisicopres AS avancefisicopres,
...
ALTER TABLE `t09_prod_ind_car_inf_se` ADD COLUMN `t09_avancefisicopres` TEXT NULL  AFTER `t09_partbenef` ;
  ...
  IF _existe <= 0 THEN 
    ...
    ELSE
        UPDATE t09_prod_ind_car_inf_se 
           SET  t09_obs = _obs, t09_partbenef = _partbenef, t09_avancefisicopres = _avancefisicopres,
            t09_avance = _avance,
            usr_actu = _usr,
            fch_actu = NOW()
          WHERE  t02_cod_proy = _proy 
