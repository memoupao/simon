...
INSERT INTO `adm_reportes` (`tit_rpt`, `des_rpt`, `url_rpt`, `url_param`, `cat_rpt`, `estado`) VALUES ('Análisis Comparativo por Producto', 'Análisis Comparativo por Producto', '/test/sme/reportes/rpt_bench_ope_prod.php', '/test/sme/reportes/filter_matriz_prod.php', '3', '1');



INSERT INTO `adm_menus` (`mnu_cod`, `mnu_nomb`, `mnu_apli`, `mnu_link`, `mnu_target`, `mnu_parent`, `mnu_activo`, `mnu_sort`, `mnu_admin`) VALUES ('MNU53001', 'Análisis Comparativo por Producto', '1', '/test/sme/reportes/reportviewer.php?ReportID=85&cboConcurso=*', '_blank', 'MNU50000', '1', '3', '0');
