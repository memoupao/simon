/*
 DA 2.0 [19-12-2013 11:49]
 Edicion de asignacion de cuentas bancarias en el proyecto
*/
...
/*
 DA 2.0 [19-12-2013 16:47]
 Directorio de instituciones: Asignacion de reponsable
*/

DELIMITER $$

DROP PROCEDURE IF EXISTS `sp_ins_resp_inst`$$

CREATE PROCEDURE `sp_ins_resp_inst`(IN pIdInst INT, IN pIdCont INT, IN pIdUser VARCHAR(20))
BEGIN
