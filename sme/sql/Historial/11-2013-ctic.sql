...
insert into `adm_menus` (`mnu_cod`, `mnu_nomb`, `mnu_apli`, `mnu_link`, `mnu_target`, `mnu_parent`, `mnu_activo`, `mnu_class`, `mnu_sort`, `mnu_img`, `mnu_admin`) values('MNU92900','Parametros','1','/ctic/Admin/man_parametros.php','_self','MNU91000','1','','8','','1');

# actualizamos los ordenes de posicion:
update `adm_menus` set `mnu_cod`='MNU92700',`mnu_nomb`='Tipos de Cuenta',`mnu_apli`='1',`mnu_link`='/ctic/Admin/man_concepto.php?item=tipo_cuenta',`mnu_target`='_self',`mnu_parent`='MNU91000',`mnu_activo`='1',`mnu_class`='',`mnu_sort`='9',`mnu_img`='',`mnu_admin`='1' where `mnu_cod`='MNU92700';
update `adm_menus` set `mnu_cod`='MNU92800',`mnu_nomb`='Tipos de Anexo',`mnu_apli`='1',`mnu_link`='/ctic/Admin/man_concepto.php?item=tipo_anexo',`mnu_target`='_self',`mnu_parent`='MNU91000',`mnu_activo`='1',`mnu_class`='',`mnu_sort`='10',`mnu_img`='',`mnu_admin`='1' where `mnu_cod`='MNU92800';

# actualizamos el termino de tasas a tasas base:
update `adm_menus` set `mnu_cod`='MNU92500',`mnu_nomb`='Tasas Base',`mnu_apli`='1',`mnu_link`='/ctic/Admin/man_tasa.php',`mnu_target`='_self',`mnu_parent`='MNU91000',`mnu_activo`='1',`mnu_class`='',`mnu_sort`='7',`mnu_img`='',`mnu_admin`='1' where `mnu_cod`='MNU92500';

/**********************************************
   sql-10112013-2116.sql
 **********************************************/
/* Nuevo menu de mantenimiento de Productos Principales*/                
insert into `adm_menus` (`mnu_cod`, `mnu_nomb`, `mnu_apli`, `mnu_link`, `mnu_target`, `mnu_parent`, `mnu_activo`, `mnu_class`, `mnu_sort`, `mnu_img`, `mnu_admin`) values('MNU91400','Productos Principales','1','/ctic/Admin/man_prodprinc_lista.php','_self','MNU91000','1','','2','','1');
...
update `adm_menus` set `mnu_cod`='MNU4900',`mnu_nomb`='Control de Pago a Supervisores Externos',`mnu_apli`='1',`mnu_link`='/ctic/sme/monitoreofe/adm/ctrl_pag_me.php',`mnu_target`='_self',`mnu_parent`='MNU40000',`mnu_activo`='1',`mnu_class`='',`mnu_sort`='9',`mnu_img`='',`mnu_admin`='0' where `mnu_cod`='MNU4900';
update `adm_menus` set `mnu_cod`='MNU4910',`mnu_nomb`='Autorización de Giro de Cheques a S.E.',`mnu_apli`='1',`mnu_link`='/ctic/sme/monitoreofe/adm/auto_giro_chk_me.php',`mnu_target`='_self',`mnu_parent`='MNU40000',`mnu_activo`='1',`mnu_class`='',`mnu_sort`='10',`mnu_img`='',`mnu_admin`='0' where `mnu_cod`='MNU4910';
update `adm_menus` set `mnu_cod`='MNU52000',`mnu_nomb`='Matriz General de Supervisión',`mnu_apli`='1',`mnu_link`='#\' onclick=\'window.open(\"/ctic/sme/reportes/reportviewer.php?ReportID=1\",\"Matriz\",\"fullscreen,scrollbars\");return false;',`mnu_target`='_blank',`mnu_parent`='MNU50000',`mnu_activo`='1',`mnu_class`='',`mnu_sort`='2',`mnu_img`='',`mnu_admin`='0' where `mnu_cod`='MNU52000';
...
VALUES (
'80', 'Cronograma de Productos', NULL , '/ctic/sme/reportes/rpt_cp.php', '/ctic/sme/reportes/filter_proy.php', '2', NULL , NULL, NULL , NULL , NULL , '1'
);