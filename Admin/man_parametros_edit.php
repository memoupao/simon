 ...
 * CticServices
 *
 * Procesa los mantenimientos de parametros derivado de man_parametros.php
 *
 * @package	Admin
 * @author	DA
 * @since	Version 2.0
...
<body class="oneColElsCtrHdr">
 ...
 <?php } ?>
    ...
    function btnGuardar_Clic() {	 
	 ...
	 var sURL = "man_parametros_process.php?action=<?php echo($action);?>&concepto=<?php echo($concepto);?>"
