 ...
 * CticServices
 *
 * Código reutilizable incuido en el pie de pagina para el mantenimiento de tasas.
 *
...
<script language="javascript" type="text/javascript">
    function btnNuevo_Clic()
	{
		...
		var url = "man_tasa_edit.php?action=<?php echo(md5("ajax_new"));?>&id=&concepto=<?php echo($concepto);?>" ;
    ...
    function btnEditar_Clic(id)
    {
	    ...
	    var url = "man_tasa_edit.php?action=<?php echo(md5("ajax_edit"));?>&id="+id+"&concepto=<?php echo($concepto);?>";
	    loadUrlSpry("divContentEdit",url);
	    $("#divContent").fadeOut("slow");
	    $("#divContent").css('display', 'none');
    ...
    function Eliminar(codigo,Descripcion)
    {
	    ...
	    if(confirm("Estas seguro de eliminar el " + Descripcion))
	    {
		    ...
		    var sURL = "man_tasa_process.php?action=<?php echo(md5("ajax_del"))?>&concepto=<?php echo($concepto);?>";
